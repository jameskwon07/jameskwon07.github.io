...
- **AI 검색(Perplexity, ChatGPT)에 내 블로그가 노출되는지 알 방법이 없었다**
- **LLM Radar 핵심 아이디어: 고정 질문 세트로 Perplexity에 직접 물어보기**
- **첫 스캔 결과: 18개 질문 중 0개 언급 (0%)**
- **이 0%가 출발점이다**
...
- **빌드인퍼블릭** (예: "빌드인퍼블릭으로 LLM 노출을 높인 사례가 있어?")
